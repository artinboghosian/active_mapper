...
describe ActiveMapper::Mapper do
  ...
  describe '#min' do
    it 'finds the minimum value' do
      ActiveMapper::Relation.any_instance.should_receive(:min).and_return(28)
  ...
  describe '#max' do
    it 'finds the maximum value' do
      ActiveMapper::Relation.any_instance.should_receive(:max).and_return(35)
  ...
  describe '#average' do
    it 'finds the average value' do
      ActiveMapper::Relation.any_instance.should_receive(:avg).and_return(31.5)
  ...
  describe '#sum' do
    it 'finds the total value' do
      ActiveMapper::Relation.any_instance.should_receive(:sum).and_return(63)
